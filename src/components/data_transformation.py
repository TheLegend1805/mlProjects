...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        fn responsible for data transformation.
        ...
        try:
            ...
            logging.info(f"categorical cols: {cat_feat}")
            logging.info(f"numerical cols: {num_feat}")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            numerical_col_name = ['reading score', 'writing score']
            ...
            logging.info(
            f"Applying preprocessing object on training n testing df"
            )
